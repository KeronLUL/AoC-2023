...
void solution(std::istream &input, size_t &sum_part1, size_t &sum_part2) {
    ...
    std::sort(cards.begin(), cards.end(), [](const Tuple &tHand1, const Tuple &tHand2) { return compare_high_card(tHand1, tHand2, "23456789TJQKA"); });
    std::sort(cards_joker.begin(), cards_joker.end(), compare_hands);
    std::sort(cards_joker.begin(), cards_joker.end(), [](const Tuple &tHand1, const Tuple &tHand2) { return compare_high_card(tHand1, tHand2, "J23456789TQKA"); });
